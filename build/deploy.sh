...
which az > /dev/null || { echo -e "$red### Azure CLI is not installed. Goodbye!$nrm"; exit 1; }
az account show > /dev/null || { echo -e "$red### You are not logged in to Azure. Goodbye!$nrm"; exit 1; }
